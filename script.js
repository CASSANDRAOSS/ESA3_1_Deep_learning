...
async function loadData() {
    try {
        ...
        if (trainingStatusDiv) {
            trainingStatusDiv.textContent = "Die Anwendung konnte nicht gestartet werden.";
        }
...
async function trainModel(X, y) {
    ...
    if (trainingStatusDiv) {
        trainingStatusDiv.textContent = "Training abgeschlossen. Modell wird ausgewertet...";
    }
}
...
resetBtn.onclick = () => {
    ...
    clearPredictions();
    statusDiv.textContent = "Eingabe zurückgesetzt. Das trainierte Modell bleibt bereit.";
};
...
async function runTraining() {
    try {
        ...
        console.error(error);
        setButtonsEnabled(false);
        statusDiv.textContent = "Die Anwendung konnte nicht vollständig gestartet werden.";
    }
}
